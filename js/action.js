...
const renderAllMovies = (movies) => {
  ...
  <div class="col-md-3 col-lg-2 carousel-hover  px-1 mb-1 mb-lg-0">
      <div class="card card-body">
        ...
        <div class="info-row2 py-2"><span class="text-success">${movies[0].name}</span><span class="border border-ligh">16+</span><span>${movies[0].category}</span><span><small class="border border-light">HD</span></small></div>
        <div>
          <ul class="d-flex py-2 px-0">
            <li class="mx-3">${movies[0].description}</li>
          </ul>
        </div>
      </div>
  </div>
  ...
  for (let i = 1; i < movies.length; i++) {
    ...
    <div class="col-md-3 col-lg-2 carousel-hover   px-1 mb-1 mb-lg-0">
        <div class="card card-body">
          ...
          <div class="info-row2 py-2"><span class="text-success">${name}</span><span class="border border-ligh">16+</span><span>${category}</span><span><small class="border border-light">HD</span></small></div>
          <div>
            <ul class="d-flex py-2 px-0">
              <li class="mx-3">${description}</li>
            </ul>
          </div>
        </div>
    </div>
